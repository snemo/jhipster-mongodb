        ...
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                this.transactionService.find(id).subscribe((transaction) => {
                    ...
                    transaction.accountCreationDate = this.datePipe
                        .transform(transaction.accountCreationDate, 'yyyy-MM-ddTHH:mm:ss');
                    transaction.lastLogin = this.datePipe
                        .transform(transaction.lastLogin, 'yyyy-MM-ddTHH:mm:ss');
